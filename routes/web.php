...
Route::group(['prefix' => 'user', 'middleware' => ['verified', 'role:user|admin|subscriber', 'PreventBackHistory']], function() {
        ...
        // USER SERVICE ROUTES NAM
        Route::get('/services', [BalanceController::class, 'index'])->name('user.balance');
        Route::get('/service/facebook/like-post', [FacebookController::class, 'listLikePost'])->name('user.service.facebook.likepost');
        Route::get('/service/facebook/like-page', [BalanceController::class, 'listPayments'])->name('user.service.facebook.likepage');
        Route::get('/service/facebook/follow', [BalanceController::class, 'listPayments'])->name('user.service.facebook.follow');
        Route::get('/service/facebook/share', [BalanceController::class, 'listPayments'])->name('user.service.facebook.share');
        Route::get('/service/facebook/comment', [BalanceController::class, 'listPayments'])->name('user.service.facebook.comment');
