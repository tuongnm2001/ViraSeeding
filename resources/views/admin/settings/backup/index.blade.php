		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				...
				<div class="card-body pt-0">
					<table class="table table-hover table align-middle table-row-dashed fs-6 gy-5" id="database-backup">
						<thead>
						...
						<tbody>
							...
							<td><div class="dropdown">
									...
									<div class="dropdown-menu table-actions-dropdown" role="menu" aria-labelledby="actions">
										<a class="dropdown-item" href="{{  route("admin.settings.backup.download", [$backup['file_name']]) }}"><i class="fa fa-download"></i> Download</a>
										<a class="dropdown-item" href="{{  route("admin.settings.backup.delete", [$backup['file_name']]) }}"><i class="fa fa-trash"></i> Delete</a>
									</div>
								</div>
							</td>
							</tr>
