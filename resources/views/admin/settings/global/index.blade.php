					...
					<form action="{{ route('admin.settings.global.store') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">									
										...
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid @error('site-name') is-danger @enderror" id="site-name" name="site-name" value="{{ config('app.name') }}" autocomplete="off">
											@error('site-name')
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<h6>Site Website</h6>
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid @error('site-website') is-danger @enderror" id="site-website" name="site-website" value="{{ config('app.url') }}" autocomplete="off">
											@error('site-website')
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										...
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid @error('site-email') is-danger @enderror" id="site-email" name="site-email" value="{{ config('app.email') }}" autocomplete="off">
											@error('site-email')
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">									
										...
										<select name="user-group" data-placeholder="Select Default New User Group" name="country" aria-label="Select a Country"  data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-semibold">	
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="form-group ">
									<div class="form-check form-check-solid form-switch form-check-custom fv-row d-flex gap-3">
										<input type="checkbox" id="reCaptcha" name="enable-recaptcha" class="form-check-input w-40px h-25px" @if ( config('services.google.recaptcha.enable')  == 'on') checked @endif>
										{{-- <span class="custom-switch-indicator" for="allowmarketing"></span> --}}
										<div class="custom-switch-description" style="margin-left: 50px">Enable Google reCaptcha</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										...
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid  @error('recaptcha-site-key') is-danger @enderror" id="recaptcha-site-key" name="recaptcha-site-key" value="{{ config('services.google.recaptcha.site_key') }}" autocomplete="off">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										...
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid @error('recaptcha-secret-key') is-danger @enderror" id="recaptcha-secret-key" name="recaptcha-secret-key" value="{{ config('services.google.recaptcha.secret_key') }}" autocomplete="off">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="form-group">
									<div class="form-check form-check-solid form-switch form-check-custom fv-row d-flex gap-3">
										<input type="checkbox" id="Analytics" name="enable-analytics" class="form-check-input w-40px h-25px" @if ( config('services.google.analytics.enable')  == 'on') checked @endif>
										{{-- <span class="custom-switch-indicator"></span> --}}
										<span class="custom-switch-descriptions" style="margin-left: 50px">Enable Google Analytics</span>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										...
										<div class="form-group">							    
											<input type="text" class="form-control form-control-lg form-control-solid @error('google-analytics') is-danger @enderror" id="google-analytics" name="google-analytics" value="{{ config('services.google.analytics.id') }}" autocomplete="off">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="form-group">
									<div class="form-check form-check-solid form-switch form-check-custom fv-row d-flex gap-3">
										<input type="checkbox" id="Maps" name="enable-maps" class="form-check-input w-40px h-25px" @if ( config('services.google.maps.enable')  == 'on') checked @endif>
										{{-- <span class="custom-switch-indicator"></span> --}}
										<span class="custom-switch-description" style="margin-left: 50px">Enable Google Maps</span>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
											...
											<div class="form-group">							    
												<input type="text" class="form-control form-control-lg form-control-solid @error('google-key') is-danger @enderror" id="google-key" name="google-key" value="{{ config('services.google.maps.key') }}" autocomplete="off">
												@error('google-key')
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="form-group">
									<div class="form-check form-check-solid form-switch form-check-custom fv-row d-flex gap-3">
										<input type="checkbox" id="Policy" name="enable-gdpr" class="form-check-input w-40px h-25px" @if ( config('cookie-consent.enabled') ) checked @endif>
										{{-- <span class="custom-switch-indicator"></span> --}}
										<span class="custom-switch-description" style="margin-left: 50px">Enable GDPR Consent Popup</span>
									</div>
								</div>	
							</div>
						</div>
						...
						<div class="border-0 text-right mb-2 mt-1">
							<a href="{{ route('admin.tts.dashboard') }}" class="btn btn-light btn-active-light-primary me-2">{{ __('Cancel') }}</a>
