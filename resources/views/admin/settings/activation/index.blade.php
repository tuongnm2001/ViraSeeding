		...
		<div class="col-xl-5 col-lg-5 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{__('License Activation') }}: @if ($notification) <span class="text-success">Activated</span> @else <span class="text-danger">Not Activated</span>@endif</h3>
				</div>
				<div class="card-body">
					<form method="POST" action="{{ route('admin.settings.activation.store') }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12">
								...
								@if ($notification) <span class="text-success fs-12">Congratulations! Application Successfully Activated!</span> @else <span class="text-danger fs-12">Application is Not Activated.</span>@endif
							</div>
						</div>
