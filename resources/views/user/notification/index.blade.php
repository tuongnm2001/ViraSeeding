	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}"> {{ __('Notifications') }}</a></li>
			</ol>			
		</div>
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-2">
					<!-- SET DATATABLE -->
					<table id='notificationsTable' class="table align-middle table-row-dashed fs-6 gy-5">
						<thead>
